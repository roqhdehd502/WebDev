					...
					<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
						<form class="login100-form validate-form">
							...
							<div class="flex-c-m">
								...
								<a href="https://kauth.kakao.com/oauth/authorize?client_id=55fbae94ad6baea8cd340f1850c2a6fe&redirect_uri=http://localhost:8282/ex/kakao_login&response_type=code" 
